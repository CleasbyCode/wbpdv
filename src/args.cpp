...
You must use the Python script "bsky/bsky_post.py" to post images to Bluesky.
...
Here is a basic usage example for the bsky_post.py Python script:

Standard image post to your profile/account.

$ python3 bsky/bsky_post.py --image your_image.webp \
